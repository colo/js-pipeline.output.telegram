...
const debug = require('debug')('js-pipeline.output.Telegram'),
      debug_events = require('debug')('js-pipeline.output.Telegram:Events'),
      debug_internals = require('debug')('js-pipeline.output.Telegram:Internals')
